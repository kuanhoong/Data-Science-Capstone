...
#file size
twitterSize<-file.info("./data/en_US/en_US.twitter.txt")$size / 1024 /1000
newsSize<-file.info("./data/en_US/en_US.news.txt")$size / 1024 /1000
blogsSize<-file.info("./data/en_US/en_US.blogs.txt")$size / 1024 /1000
...
```{r, echo=FALSE, warning=FALSE, fig.width=7, fig.height=5, message=FALSE}
